    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="mt-8 bg-white border-l-4 border-yellow-500 p-6 shadow-lg rounded-lg">
                <img src="<?php echo e(asset('img/benuanta.jpg')); ?>" alt="Berita 1" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <!-- Berita 2 -->
            <div class="mt-8 bg-white border-l-4 border-yellow-500 p-6 shadow-lg rounded-lg">
                <img src="<?php echo e(asset('img/berita4.png')); ?>" alt="Berita 2" class="w-full h-48 object-cover">
                <div class="p-6">
                    <p class="text-gray-700 text-sm flex items-center">
            ...
            <!-- Berita 3 -->
            <div class="mt-8 bg-white border-l-4 border-yellow-500 p-6 shadow-lg rounded-lg">
                <img src="<?php echo e(asset('img/radartarakan.jpg')); ?>" alt="Berita 2" class="w-full h-48 object-cover">
                <div class="p-6">
                    <p class="text-gray-700 text-sm flex items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Dkptengkayu2\resources\views/informasi/berita.blade.php ENDPATH**/ ?>