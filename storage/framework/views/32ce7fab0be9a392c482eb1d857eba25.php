    ...
    <div class="container mx-auto py-12 px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="bg-white border-l-4 border-yellow-500 p-6 shadow-lg rounded-lg">
                ...
                <img src="<?php echo e(asset('img/sejarah.png')); ?>" alt="Logo sejarah" class="w-150 h-auto rounded-lg shadow-md hover:scale-105 transition-transform">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Dkptengkayu2\resources\views/informasi/sejarah.blade.php ENDPATH**/ ?>